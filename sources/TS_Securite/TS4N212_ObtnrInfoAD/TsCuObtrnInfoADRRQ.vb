...
Friend Class TsCuObtnrInfoADRRQ
...
#Region " Propriétés "
    Public ReadOnly Property Domaine As TsIadNomDomaine Implements TsIObtnrInfoAD.Domaine
        Get
            Return TsIadNomDomaine.TsDomaineRRQ
        End Get
    End Property
        ...
        Try
            ...
            If dtAD.Rows.Count = 1 Then
                utilisateurAD = New TsCuUtilisateurAD(strCodeUtilisateur, _
                    ...
                    CStr(IIf(IsDBNull(dtAD.Rows(0).Item("Title")) = False, dtAD.Rows(0).Item("Title").ToString, String.Empty)), _
                    CStr(IIf(IsDBNull(dtAD.Rows(0).Item("company")) = False, dtAD.Rows(0).Item("company").ToString, String.Empty)), _
...
#Region " Fonctions et méthodes privés "
    ...
    Private Sub CombinerTypeRequeteVSAttributAD() Implements TsIObtnrInfoAD.CombinerTypeRequeteVSAttributAD
        ...
        _relationTypeReqAttributAD.AjouterCombinaison(TsIadTypeRequete.TsIadTrUniteAdmn, "Department")
        _relationTypeReqAttributAD.AjouterCombinaison(TsIadTypeRequete.TsIadTrFonction, "Title")
        ...
        _relationTypeReqAttributAD.AjouterCombinaison(TsIadTypeRequete.TsIadTrSociete, "company")
    ...
    Private ReadOnly Property NomServeur() As String Implements TsIObtnrInfoAD.NomServeur
        Get
            ...
            Dim nomServeurADRRQ As String = XuCuConfiguration.ValeurSysteme("TS4", "TS4\CheminServeurActiveDirectory")

            If nomServeurADRRQ.Length > 2 Then nomServeurADRRQ = nomServeurADRRQ.Substring(2)

            Return nomServeurADRRQ
