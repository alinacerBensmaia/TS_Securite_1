...
namespace Rq.Infrastructure.Securite.SignatureDigital.Internes
{
    internal class AppConfiguration
    {
        ...
        public static string AjouterAuditNTFS
        {
            get { return getValeurSysteme("AjouterAuditNTFS"); }
        }


        private static string getValeurSysteme(string clef)
        {
            return XuCuConfiguration.get_ValeurSysteme("TS1", string.Format(@"TS1\TS1N152\{0}", clef));
        }
