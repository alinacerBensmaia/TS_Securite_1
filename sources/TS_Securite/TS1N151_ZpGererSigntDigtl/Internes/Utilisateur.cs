...
namespace Rq.Infrastructure.Securite.SignatureDigital.Internes
{
    internal class Utilisateur
    {
        ...
        private readonly string _cheminProfil;
        ...
        public Utilisateur(string identifiant, string nom, string prenom, string numeroEmploye, string ville, string cheminProfil)
        {
            Valide = true;
        ...
        public string CheminProfil
        {
            get
            {
                if (!Valide) throw new InvalidDataException();
                return _cheminProfil;
            }
        }
    }
}
