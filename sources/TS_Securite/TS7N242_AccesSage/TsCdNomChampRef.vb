...
Public Class TsCdNomChampRef
    ...
    ''' <summary>
    ''' Avoir le dictionnaire d'affilation des noms de champs Sage.
    ''' </summary>
    ...
    ''' <summary>
    ''' Fonction de services. Sert à construire le dictionnaire de références, s'il ne l'est pas déja.
    ''' </summary>
    ...
    Private Shared Function ConstruireDictioRef() As Dictionary(Of String, TsCdChampSage)
        ...
        With paramRetour
            '! add(Nom normalisé du champ, (Numéro du champ, Nom du champ dans sage))
            '! note : Les numéros de champ égale à -1 indique que se sont des champ de base.

            '! UTILISATEUR
            .Add(USER.ID, New TsCdChampSage(-1, "UserID"))
            ...
            '! RÔLE
            .Add(ROLE.ID, New TsCdChampSage(-1, "RoleID"))
            .Add(ROLE.NAME, New TsCdChampSage(-1, "RoleName"))
            .Add(ROLE.DESCRIPTION, New TsCdChampSage(-1, "RoleDescription"))
            .Add(ROLE.ORGANIZATION, New TsCdChampSage(-1, "RoleOrganization"))
            .Add(ROLE.OWNER, New TsCdChampSage(-1, "RoleOwner"))
            .Add(ROLE.TYPE, New TsCdChampSage(-1, "RoleType"))
            .Add(ROLE.CREATE_DATE, New TsCdChampSage(-1, "RoleCreateDate"))
            .Add(ROLE.EXPIRATION_DATE, New TsCdChampSage(-1, "RoleExpirationDate"))
            .Add(ROLE.REVIEWER, New TsCdChampSage(-1, "RoleReviewer"))
            .Add(ROLE.APPROVE_CODE, New TsCdChampSage(-1, "RoleApproveCode"))
            .Add(ROLE.APPROVED_DATE, New TsCdChampSage(-1, "RoleApprovedDate"))
            .Add(ROLE.FILTER, New TsCdChampSage(-1, "RoleFilter"))
            .Add(ROLE.ORGANIZATION2, New TsCdChampSage(-1, "RoleOrganization2"))
            .Add(ROLE.ORGANIZATION3, New TsCdChampSage(-1, "RoleOrganization3"))
            ...
            .Add(RESSOURCE.FIELD_VALUE_1, New TsCdChampSage(1, "Nom fonctionnel ou Description"))
            .Add(RESSOURCE.FIELD_VALUE_2, New TsCdChampSage(2, "CN"))
            .Add(RESSOURCE.FIELD_VALUE_3, New TsCdChampSage(3, "Détails"))
            .Add(RESSOURCE.FIELD_VALUE_4, New TsCdChampSage(4, "Détenteur"))
            .Add(RESSOURCE.FIELD_VALUE_5, New TsCdChampSage(5, "Date création"))
            .Add(RESSOURCE.FIELD_VALUE_6, New TsCdChampSage(6, "Dernière modification"))
        End With
...
Public Class TsCdConstanteNomChampNorm
    ...
    Public Class USER
        ...
        Public Const CHAMP_9 As String = "Champ 9 pas utilisé"
    ...
    Public Class ROLE
        ...
        Public Const FILTER As String = "Role_Filter"
    End Class
