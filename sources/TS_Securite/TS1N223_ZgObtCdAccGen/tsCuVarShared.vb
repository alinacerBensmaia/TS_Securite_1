...
Friend Class tsCuVarShared
    ...
    'Clé d'encryption
    Friend Shared K() As Byte = {175, 9, 217, 205, 171, 255, 240, 107, 210, 82, 94, 242, 92, 213, 130, 118, 227, 155, 114, 118, 142, 215, 168, 244, 12, 135, 4, 32, 234, 117, 53, 164}

    'Vecteur d'initialisation
    Friend Shared V() As Byte = {42, 235, 220, 217, 248, 82, 28, 111, 251, 163, 79, 126, 139, 163, 196, 187}
