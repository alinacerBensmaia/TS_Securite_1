...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TS7SRechercherEmployeAD.aspx.vb"
    Inherits="TS7I111_AccesUtilisateur.TS7SRechercherEmployeAD" %>
...
<body>
    ...
    <div class="page">
        ...
        <div class="pageCentre texte">
            <asp:Label ID="lblTitre" runat="server" CssClass="titre">Rechercher un employé Active Directory</asp:Label>
            
                <cc1:XlCrAffchAscxPartage ID="ctrlNI1P514_RechercheUtilAD" runat="server" NomASCX="NI1P514_RechercheUtilAD" />
