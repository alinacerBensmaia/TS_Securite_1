...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Table"
        balise &= ConstruireAttributOptionnel("ss:DefaultColumnWidth", DefaultColumnWidth)
        balise &= ConstruireAttributOptionnel("ss:DefaultRowHeight", DefaultRowHeight)
        balise &= ConstruireAttributOptionnel("ss:ExpandedColumnCount", ExpandedColumnCount)
        balise &= ConstruireAttributOptionnel("ss:ExpandedRowCount", ExpandedRowCount)
        balise &= ConstruireAttributOptionnel("ss:LeftCell", LeftCell)
        balise &= ConstruireAttributOptionnel("ss:StyleID", StyleID)
        balise &= ConstruireAttributOptionnel("ss:TopCell", TopCell)
        balise &= ConstruireAttributOptionnel("x:FullColumns", FullColumns)
        balise &= ConstruireAttributOptionnel("x:FullRows", FullRows)
