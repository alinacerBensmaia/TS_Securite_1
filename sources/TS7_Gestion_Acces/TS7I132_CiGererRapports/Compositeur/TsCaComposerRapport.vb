...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirRapport() As String
        ...
        Dim erreurConditionFormating As String = "ErreurConditionFormating"
        ...
        For Each v In lstFeuille
            For Each c In v.ConditionnalFormattings
                If String.Concat(c.Condition.Values).Length() > 8000 Then Return erreurConditionFormating
            Next
        Next
...
#Region "--- Fonctions privées ---"
    ...
    Private Function FabriquerCompositeur(pIdentifiant As String, pSource As TsDtSourceRapport) As TsICompositeurFeuille
        ...
        Select Case pIdentifiant
            ...
            Case TsCuConstantesRapport.ID_FEUILLE_2
                retour = New TsCaFeuilleSecondaire(pSource)
        End Select
