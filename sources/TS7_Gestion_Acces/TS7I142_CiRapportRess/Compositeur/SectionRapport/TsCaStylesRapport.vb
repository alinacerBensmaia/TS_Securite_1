...
Public Class TsCaStylesRapport
    ...
    Private Const STYLE_LIGNE_DEFAUT_DOUBLE As TsCuStyleBorder.LineStyleType = TsCuStyleBorder.LineStyleType.Double
...
#Region "--- Style défaut ---"
    ...
    Public Shared Function ObtenirParDefaut() As TsCuStyle
        Dim defaut As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_DEFAULT)
...
#Region "--- Style général ---"
    ...
    Public Shared Function ObtenirHyperLien() As TsCuStyle
        Dim defaut As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_HYPERLIEN)
...
#Region "--- Styles en-tête ---"
    ...
    Public Shared Function ObtenirCelluleEnteteRapport() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_ENTETE_RAPPORT)
    ...
    Public Shared Function ObtenirCelluleEnteteTableau() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_ENTETE_TABLEAU)
        ...
        With style
            ...
            End With
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT_DOUBLE, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT_DOUBLE, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT_DOUBLE, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT_DOUBLE, .Weight = 1})
        End With
...
#Region "--- Styles sous en-tête ---"
    ...
    Public Shared Function ObtenirCelluleSousEnteteTableau() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_ENTETE_TABLEAU)
        With style
            With .Alignment
                .Vertical = TsCuStyleAlignment.VerticalType.Bottom
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
...
#Region "--- Styles UA ---"
    ...
    Public Shared Function ObtenirCelluleUA() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_UA)
...
#Region "--- Styles en-tête coupé ---"
    ...
    Public Shared Function ObtenirCelluleEnteteCoupe() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_ENTETE_COUPE)
    ...
    Public Shared Function ObtenirCelluleNom() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM)
        With style
    ...
    Public Shared Function ObtenirCelluleNomHaut() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM_HAUT)
        With style
            .Alignment.ShrinkToFit = True
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleNomBas() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM_BAS)
        With style
            .Alignment.ShrinkToFit = True
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleNoUA() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NO_UA)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM
            With .Alignment
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
                .Vertical = TsCuStyleAlignment.VerticalType.Center
            End With
    ...
    Public Shared Function ObtenirCelluleNoUAHaut() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NO_UA_HAUT)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM_HAUT
            With .Alignment
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
                .Vertical = TsCuStyleAlignment.VerticalType.Center
            End With
    ...
    Public Shared Function ObtenirCelluleNoUABas() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_NO_UA_BAS)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_NOM_BAS
            With .Alignment
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
                .Vertical = TsCuStyleAlignment.VerticalType.Center
            End With
...
#Region "--- Styles sous En-tête coupé ---"
    ...
    Public Shared Function ObtenirCelluleSousEnteteCoupe() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_ENTETE_COUPE)
        ...
        With style
            ...
            End With
            With .Interior
                .Color = TsCuConstantesRapport.ConstantesCouleur.GRIS_PALE
                .Pattern = TsCuStyleInterior.PatternType.Solid
            End With
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleContexteGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_CONTEXTE_GAUCHE)
        With style
            With .Interior
                .Color = TsCuConstantesRapport.ConstantesCouleur.BLANC
                .Pattern = TsCuStyleInterior.PatternType.Solid
            End With
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleContexteDroite() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_CONTEXTE_DROITE)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_CONTEXTE_GAUCHE
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleTotal() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_TOTAL)
        With style
            With .Alignment
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
            End With
    ...
    Public Shared Function ObtenirCelluleTotalGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_TOTAL_GAUCHE)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_TOTAL
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = TsCuStyleBorder.LineStyleType.Continuous, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleSousTotal() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL)
        With style
            With .Alignment
                .Horizontal = TsCuStyleAlignment.HorizontalType.Center
            End With
    ...
    Public Shared Function ObtenirCelluleSousTotalGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL_GAUCHE)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
    ...
    Public Shared Function ObtenirCelluleSousTotalBarre() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL_BARRE)
        With style
            With .Interior
                .PatternColor = TsCuConstantesRapport.ConstantesCouleur.NOIR
    ...
    Public Shared Function ObtenirCelluleSousTotalBarreGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL_BARRE_GAUCHE)
        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_SOUS_TOTAL_BARRE
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
...
#Region "--- Styles grille ---"
    ...
    Public Shared Function ObtenirCelluleGrille() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_GRILLE)
    ...
    Public Shared Function ObtenirCelluleGrilleMarque() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_GRILLE_MARQUE)

        With style
            .Parent = TsCuConstantesRapport.ConstantesStyle.CELLULE_GRILLE
            With .Interior
                .Color = "#FF5533"
                .Pattern = TsCuStyleInterior.PatternType.Solid
            End With
...
#Region "--- Styles légende ---"
    ...
    Public Shared Function ObtenirCelluleLegendeBarree() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_LEGENDE_BARREE)
        With style
            With .Interior
                .Pattern = TsCuStyleInterior.PatternType.ThinDiagStripe
                .PatternColor = TsCuConstantesRapport.ConstantesCouleur.NOIR
    ...
    Public Shared Function ObtenirCelluleLegendeJaune() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_LEGENDE_JAUNE)
        With style
            With .Interior
                .Color = TsCuConstantesRapport.ConstantesCouleur.JAUNE
                .Pattern = TsCuStyleInterior.PatternType.Solid
            End With
        End With
        Return style
    ...
    Public Shared Function ObtenirCelluleLegendeTexte() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_LEGENDE_TEXTE)
        With style
            .Alignment.ShrinkToFit = True
        End With
        Return style
...
#Region "--- Styles séparateur ---"
    ...
    Public Shared Function ObtenirCelluleSeparateurFonce() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SEPARATEUR_FONCE)
        With style
            With .Interior
                .Color = TsCuConstantesRapport.ConstantesCouleur.GRIS_FONCE
                .Pattern = TsCuStyleInterior.PatternType.Solid
            End With
        End With
        Return style
    ...
    Public Shared Function ObtenirCelluleSeparateurPale() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_SEPARATEUR_PALE)
        With style
            With .Interior
                .Color = TsCuConstantesRapport.ConstantesCouleur.GRIS_PALE
                .Pattern = TsCuStyleInterior.PatternType.Solid
    ...
    Public Shared Function ObtenirCelluleVideGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_GAUCHE)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
        Return style
    ...
    Public Shared Function ObtenirCelluleVideDroite() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_DROITE)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
        Return style
    ...
    Public Shared Function ObtenirCelluleVideHaut() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_HAUT)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
        Return style
    ...
    Public Shared Function ObtenirCelluleVideCoinHautGauche() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_COIN_HAUT_GAUCHE)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Left) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
    ...
    Public Shared Function ObtenirCelluleVideCoinHautDroit() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_COIN_HAUT_DROIT)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Top) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Right) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
    ...
    Public Shared Function ObtenirCelluleVideBas() As TsCuStyle
        Dim style As New TsCuStyle(TsCuConstantesRapport.ConstantesStyle.CELLULE_VIDE_BAS)
        With style
            .Borders.Add(New TsCuStyleBorder(TsCuStyleBorder.PositionType.Bottom) With {.LineStyle = STYLE_LIGNE_DEFAUT, .Weight = 1})
        End With
        Return style
