...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Border"
        balise &= TsCuOutilsExcel.ConstruireAttribut("ss:Position", Position)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Color", Color)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:LineStyle", LineStyle)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Weight", Weight)
        balise &= "/>"
