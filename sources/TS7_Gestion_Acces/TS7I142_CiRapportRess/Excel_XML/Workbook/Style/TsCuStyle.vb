...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Style"
        balise &= TsCuOutilsExcel.ConstruireAttribut("ss:ID", ID)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Name", Name)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Parent", Parent)
        balise &= ">"
