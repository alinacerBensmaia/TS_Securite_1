...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Font"
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Bold", Bold)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Color", Color)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:FontName", FontName)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Italic", Italic)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Outline", Outline)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Outline", Outline)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Shadow", Shadow)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Size", Size)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:StrikeThrough", StrikeThrough)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Underline", Underline)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:VerticalAlign", VerticalAlign)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:CharSet", CharSet)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Family", Family)
        balise &= "/>"
