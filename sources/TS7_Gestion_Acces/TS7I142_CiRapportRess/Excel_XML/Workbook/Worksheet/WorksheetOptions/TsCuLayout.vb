...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Layout"
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:CenterHorizontal", CenterHorizontal)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:CenterVertical", CenterVertical)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Orientation", Orientation)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:StartPageNumber", StartPageNumber)
        balise &= "/>"
