...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<PageMargins"
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Bottom", Bottom)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Left", Left)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Right", Right)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Top", Top)
        balise &= "/>"
