...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Cell"
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("c:PasteFormula", PasteFormula)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:ArrayRange", ArrayRange)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Formula", Formula)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:HRef", HRef)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Index", Index)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:MergeAcross", MergeAcross)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:MergeDown", MergeDown)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:StyleID", StyleID)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:HRefScreenTip", HRefScreenTip)
