...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= "<Row"
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("c:Caption", Caption)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:AutoFitHeight", AutoFitHeight)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Hidden", Hidden)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Index", Index)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Span", Span)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:StyleID", StyleID)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("ss:Height", Height)
