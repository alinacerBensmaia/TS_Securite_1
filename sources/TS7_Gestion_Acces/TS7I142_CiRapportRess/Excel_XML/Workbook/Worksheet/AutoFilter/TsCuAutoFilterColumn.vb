...
#Region "--- Méthodes ---"
    ...
    Public Function ObtenirXML() As String
        ...
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Hidden", Hidden)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Index", Index)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Type", Type)
        balise &= TsCuOutilsExcel.ConstruireAttributOptionnel("x:Value", Value)
